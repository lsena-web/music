...
@section('title', 'YourMusic - Cadastrar Música')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form action="/musica" method="POST" class="row g-3 needs-validation" novalidate>
                                @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ex: 3min ou 3.5minutos"
                                        name="durable" required value="{{ old('durable') }}">
                                    <div class="invalid-feedback">
                                        Campo obrigatório!
                                    </div>
                                </div>
